...
public class OverloadMigrator implements PipelineMigrator {
    ...
    public void doLoadShedding(List<SpServiceRegistration> spServiceRegistrations) {
        ...
        PriorityQueue<Map.Entry<SpServiceRegistration, Float>> maxQueue = new PriorityQueue<>((a, b)->{
            return Float.compare(b.getValue(),a.getValue());
        });

        PriorityQueue<Map.Entry<SpServiceRegistration, Float>> minQueue = new PriorityQueue<>((a,b)->{
            return Float.compare(a.getValue(),b.getValue());
        });
