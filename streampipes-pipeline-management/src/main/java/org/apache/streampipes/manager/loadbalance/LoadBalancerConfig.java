...
public class LoadBalancerConfig {
    ...
    // Bandwidth In usage weight when calculating new resource usage
    public static double BandwithInResourceWeight = 1.0;

    // Bandwidth Out usage weight when calculating new resource usage
    public static double BandwithOutResourceWeight = 1.0;
