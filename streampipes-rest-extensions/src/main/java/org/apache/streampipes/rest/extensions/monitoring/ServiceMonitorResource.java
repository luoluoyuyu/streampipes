...
import org.apache.streampipes.extensions.api.monitoring.ServiceUsageReportGenerator;
...
public class ServiceMonitorResource extends AbstractExtensionsResource {
    ...
    public ResponseEntity<ServiceUsageReport> getServiceMonitor() {
        return ok(ServiceUsageReportGenerator.generateReport());
    }
}
